...
void HinhHoc::RenderRectangle(const FormatHinhHoc& geo_size, const ColorData& color_data, SDL_Renderer* screen)
{
...
void HinhHoc::RenderOutline(const FormatHinhHoc& geo_size, const ColorData& color_data, SDL_Renderer* screen)
{
